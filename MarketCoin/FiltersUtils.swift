...
//  MarketCoin
//
//  Created by Ezequias Santos on 14/10/23.
//
...
enum OrderByFilterEnum: String, CaseIterable {
    ...
    var order: String {
        switch self {
        case .marketCapDesc, .volumeDes: return "\u{2193}" //Seta para cima
        case .marketCapAsc, .volumeAsc: return "\u{2191}" //Seta para baixo
        }
    }
}
